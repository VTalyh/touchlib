// Todo: Make this class just create a bunch of pictures.. Add ability to view flickr recent
// pics

// Fix finger removed jumping.. 

// Have a button to switch to 'recent' pictures on flickr
// and a 'more' button..

// fix 0,0 blobs

// switch my screen size to 1.0

// why is OSC sending so many 0,0 blobs?

// make better stand for screen..
// make holder for projector..


package 
{
	// Various packages for display objects, events and data networking
	...
	public class Flickr
	{
		...
		// Constructor
		public function Flickr(d:DisplayObject) 
		{
			thestage = d;
			allPics = new Array();
